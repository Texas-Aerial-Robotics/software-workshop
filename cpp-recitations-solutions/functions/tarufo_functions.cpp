...
void end_game(string codeword, string answer){
    string output;
    if(answer==codeword){
        output = "\nHooray! You saved the person! Congratulations, you have earned yourself the TAR Up-and-Coming Cracked Award.";
    }
    else{
        output = "\nYou've failed! Your world now faces DOOM!";
    }
